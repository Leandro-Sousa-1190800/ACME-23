...
public class Review {
    ...
    public Review(final Long idReview, final long version, final String approvalStatus, final  String reviewText, final List<Vote> upVote, final List<Vote> downVote, final String report, final LocalDate publishingDate, final String funFact, int product, Rating rating, Long user) {
    ...
    public Review(final String reviewText, LocalDate publishingDate, int product, String funFact, Rating rating, Long user) {
        setReviewText(reviewText);
        setProduct(product);
        setPublishingDate(publishingDate);
